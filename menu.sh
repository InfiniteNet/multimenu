...
BOTWHATSAPP () {
    sudo apt install -y git && git clone https://github.com/InfiniteNet/whaticket-instalador.git && sudo chmod -R 777 whaticket-saas && cd whaticket-saas && sudo ./install_primaria
}    
ATTSSL () {
